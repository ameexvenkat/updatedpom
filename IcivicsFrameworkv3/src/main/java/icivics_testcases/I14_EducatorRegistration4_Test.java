...
public class I14_EducatorRegistration4_Test extends ProjectSpecificMethods {
	...
	public void C358_verifybreadcrumbspage4(String URL) throws IOException, InterruptedException {
		...
		new EducatorRegistration4(driver, node, prop).launchURL(URL).verifywithvaliddata().verifypagecount4();
	}
	...
	public void C359_verifypreviouspage(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new EducatorRegistration4(driver, node, prop).launchURL(URL).verifywithvaliddata().clickbackbutton();
	}
	...
	public void C360_verifyalldataremembered(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new EducatorRegistration4(driver, node, prop).launchURL(URL).verifywithvaliddata().verifySchoolremembered()
	...
	public void C361_verifyallpage3fields(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new EducatorRegistration4(driver, node, prop)
		.launchURL(URL)
		.verifywithvaliddata()
