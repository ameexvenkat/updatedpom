...
public class I20_StudentRegistration1classcode_Test extends ProjectSpecificMethods {
	...
	public void C425_verifyemailfieldsappear(String URL) throws IOException, InterruptedException {
		...
		new StudentRegistration1classcode(driver, node, prop).launchstudentURL(URL).verifyOptionallink();
	}
	...
	public void C426_verifyemailtooltips(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration1classcode(driver, node, prop).launchstudentURL(URL).hoveronemailfield()
	...
	public void C427_verifyemailfieldsdisappear(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration1classcode(driver, node, prop).launchstudentURL(URL).clickonremovelink();
	}
	...
	public void C428_verifyusernamepregenerated(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration1classcode(driver, node, prop).launchstudentURL(URL).usernamepregenerated();
	}
	...
	public void C429_usernamegeneratedrandomly(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration1classcode(driver, node, prop).launchstudentURL(URL).usernamegeneratedrandomly();
	}
	...
	public void C430_verifyregistrationwithvaliddata(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration1classcode(driver, node, prop).launchstudentURL(URL).clickOptionallink()
	...
	public void C432_verifyinvaliderrormsg(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration1classcode(driver, node, prop).launchstudentURL(URL).verifyinvaliderrormsg();
	}
	...
	public void C433_verifyerrormsgverifyemailblankfield(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration1classcode(driver, node, prop).launchstudentURL(URL).verifyerrormsgblankfieldall()
	...
	public void C434_verifyinvaliderrormsg2(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration1classcode(driver, node, prop).launchstudentURL(URL).verifyinvaliderrormsg2();
	}
	...
	public void C435_verifyregistrationwithvalidvalue(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(spark);
		new StudentRegistration1classcode(driver, node, prop).launchstudentURL(URL).verifyregistrationwithvalidvalue();
	}
}
