...
public class I10_EducatorRegistration_Test extends ProjectSpecificMethods {
	...
	public void C321_VerifyallpageElements(String URL) throws IOException, InterruptedException {
		...
		new EducatorRegistration(driver, node, prop).launchURL(URL).verifyeducatorpage(URL).pagecounter().username()
	...
	public void C322_ButtonHover(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(reporter);
		new EducatorRegistration(driver, node, prop).launchURL(URL).verifyeducatorpage(URL).hoverplaybutton()
	...
	public void C323_Verifyallbuttonlinks(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(reporter);
		new EducatorRegistration(driver, node, prop).launchURL(URL).verifyeducatorpage(URL)
	...
	public void C324_WindowResize(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(reporter);
		new EducatorRegistration(driver, node, prop).launchURL(URL).verifyeducatorpage(URL).resizewindow();
	}
	...
	public void C325_Verifyerrormsg(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(reporter);
		new EducatorRegistration(driver, node, prop).launchURL(URL).verifyeducatorpage(URL).typos();
	}
	...
	public void C326_Verifybreadcrumbs(String URL) throws IOException, InterruptedException {
		...
		extent.attachReporter(reporter);
		new EducatorRegistration(driver, node, prop).launchURL(URL).verifyeducatorpage(URL).pagebreadcrumbs();
	}
