...
public class HP_4HeaderAbout extends ProjectSpecificMethods {
	...
	public HP_4HeaderAbout(RemoteWebDriver driver, ExtentTest node, Properties prop) {
		this.driver = driver;
		this.node = node;
		this.prop = prop;
	}
	...
	public HP_4HeaderAbout launchURL(String URL) {
		navigateto(URL);
		return this;
	...
	public HP_4HeaderAbout aboutbuttonelementsverification(String URL) throws IOException {
