...
public class HP_3HeaderTeach extends ProjectSpecificMethods {
	...
	public HP_3HeaderTeach(RemoteWebDriver driver, ExtentTest node, Properties prop) {
		this.driver = driver;
		this.node = node;
		this.prop = prop;
	}
	...
	public HP_3HeaderTeach launchURL(String URL) {
		navigateto(URL);
		return this;
	...
	public HP_3HeaderTeach Teachbuttonelementsverification(String URL) throws IOException {
