...
public class HP_2HeaderPlay extends ProjectSpecificMethods {
	...
	public HP_2HeaderPlay(RemoteWebDriver driver, ExtentTest node, Properties prop) {
		this.driver = driver;
		this.node = node;
		this.prop = prop;
	}
	...
	public HP_2HeaderPlay launchURL(String URL) {
		navigateto(URL);
		return this;
	...
	public HP_2HeaderPlay Playbuttonelementsverification(String URL) throws IOException {
