...
public class HP_5HeaderSigninMisc extends ProjectSpecificMethods {
	...
	public HP_5HeaderSigninMisc(RemoteWebDriver driver, ExtentTest node, Properties prop) {
		this.driver = driver;
		this.node = node;
		this.prop = prop;
	}
	...
	public HP_5HeaderSigninMisc launchURL(String URL) {
		navigateto(URL);
		return this;
	...
	public HP_5HeaderSigninMisc Signinbuttonelementsverification(String URL) throws IOException {
