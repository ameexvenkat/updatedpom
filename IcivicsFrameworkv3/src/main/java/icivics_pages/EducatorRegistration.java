...
public class EducatorRegistration extends ProjectSpecificMethods {
	...
	public EducatorRegistration(RemoteWebDriver driver, ExtentTest node, Properties prop) {
		this.driver = driver;
		this.node = node;
		this.prop = prop;
	}
	...
	public EducatorRegistration launchURL(String URL) {
		navigateto(URL);
		return this;
	}

	@When("Educatorregistration page is verified successfully")
	public EducatorRegistration verifyeducatorpage(String URL) {
	...
	public EducatorRegistration Playbuttonelementsverification(String URL) throws IOException {
	...
	public EducatorRegistration Teachbuttonelementsverification(String URL) throws IOException {
	...
	public EducatorRegistration aboutbuttonelementsverification(String URL) throws IOException {
