...
public class StudentRegistration3classcode extends ProjectSpecificMethods {
	...
	public StudentRegistration3classcode(RemoteWebDriver driver, ExtentTest node, Properties prop) {
		this.driver = driver;
		this.node = node;
		this.prop = prop;
	}
	...
	public StudentRegistration3classcode launchstudentURL(String URL) {
		navigateto(URL);
		return this;
	}
